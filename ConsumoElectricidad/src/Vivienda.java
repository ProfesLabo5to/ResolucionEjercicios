...
public abstract class Vivienda {
    ...
    public abstract int getPrecio(); //En cada clase que extiende de esta se va a retornar el valor de kwh puntual

    public void cargarConsumo(LocalDate fecha, int consumo){
        Consumo cAux= new Consumo(consumo, getPrecio()); //guardo lo que consumió y el valor de kwh en ese momento
    ...
    public double calcularTotalUnaFechaDeterminada(LocalDate fecha) {
